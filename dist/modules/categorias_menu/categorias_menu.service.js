...
let CategoriasMenuService = class CategoriasMenuService {
    create(createCategoriasMenuDto) {
        return 'This action adds a new categoriasMenu';
    }
    findAll() {
        return `This action returns all categoriasMenu`;
    }
    findOne(id) {
        return `This action returns a #${id} categoriasMenu`;
    }
    update(id, updateCategoriasMenuDto) {
        return `This action updates a #${id} categoriasMenu`;
    }
    remove(id) {
        return `This action removes a #${id} categoriasMenu`;
    }
};
