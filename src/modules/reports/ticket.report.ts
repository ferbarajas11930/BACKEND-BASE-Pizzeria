import type { TDocumentDefinitions, Margins } from 'pdfmake/interfaces';

export const getTicketReport = (options: any): TDocumentDefinitions => {
      ...
      // Detalle de la pizza 
      {
        table: {
          ...
          body: [
            ...
            ...ticket.pedido.detalles.map((d: any) => [
...
// export const getTicketReport = (
//   options: TicketReportOptions,
...
//         alignment: 'center' as const,
//         fontSize: 10,
//         margin: [0, 2, 0, 6] as Margins,
//       },
//       {
//         text: new Date(ticket.fechaHora).toLocaleString('es-MX'),
//         fontSize: 8,
//         margin: [0, 0, 0, 6] as Margins,
//       },
//       {
//         canvas: [
//           { type: 'line', x1: 0, y1: 0, x2: 206, y2: 0, lineWidth: 0.5 },
//         ],
//       },
//       {
...
//       },
//       { text: `IVA:        $${ticket.iva.toFixed(2)}`, fontSize: 9 },
//       ...(ticket.descuento > 0
//         ? [{ text: `Descuento: -$${ticket.descuento.toFixed(2)}`, fontSize: 9 }]
//         : []),
//       ...(ticket.tarifaEnvio > 0
//         ? [
//             {
//               text: `Envío:      $${ticket.tarifaEnvio.toFixed(2)}`,
//               fontSize: 9,
//             },
//           ]
//         : []),
